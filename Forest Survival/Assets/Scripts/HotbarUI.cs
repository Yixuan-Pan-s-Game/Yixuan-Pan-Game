...
// Hotbar UI controller that displays quick slots and the current selection.
public class HotbarUI : MonoBehaviour
{
    ...
    // Inventory or crafting data for items, recipes, slots, or stack counts: slotBackgrounds.
    private Image[] slotBackgrounds;
    // Inventory or crafting data for items, recipes, slots, or stack counts: slotLabels.
