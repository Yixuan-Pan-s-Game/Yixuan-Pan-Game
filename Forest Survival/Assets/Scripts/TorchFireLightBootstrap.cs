...
public class TorchFireLightBootstrap : MonoBehaviour
{
    ...
    // Ensures the objects, references, or configuration required for ensure bootstrap exist.
    ...
    // Adds, spawns, or attaches the objects and data for attach to scene torches.
    ...
    // Finds, loads, or caches the references needed for find torch root.
    ...
    // Handles the estimate torch top offset workflow.
