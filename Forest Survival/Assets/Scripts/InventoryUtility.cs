...
// Shared inventory helpers for stacking, finding, adding, and removing items.
public static class InventoryUtility
{
    // Handles the normalize item id workflow.
    ...
    // Calculates and returns the result for get item id.
    ...
    // Creates or rebuilds the runtime objects, assets, or UI for create slot from definition.
    ...
    // Handles the clone slot workflow.
    ...
    // Calculates and returns the result for can stack.
    ...
    // Calculates and returns the result for can add item.
    ...
    // Calculates and returns the result for is valid slot.
